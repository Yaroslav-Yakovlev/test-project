...
const AppRouter = () => {
    const data = [
        ...
        {id: 4, brand: 'iPhone', price: '28 400', screen: '5.7', memory: '64GB'},
        {id: 5, brand: 'iPhone', price: '38 600', screen: '7.7', memory: '128GB'},
        {id: 6, brand: 'iPhone', price: '48 800', screen: '8.7', memory: '512GB'},
    ]
